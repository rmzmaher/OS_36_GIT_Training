...
var Composition = Edge.Composition, Symbol = Edge.Symbol; // aliases for commonly used Edge classes
   ...
   (function(symbolName) {
      ...
      Symbol.bindElementAction(compId, symbolName, "${_m2}", "mouseenter", function(sym, e) {
      ...
      Symbol.bindElementAction(compId, symbolName, "${_m2}", "mouseleave", function(sym, e) {
         var currentSym = sym.getSymbol("m2");
      ...
      Symbol.bindElementAction(compId, symbolName, "${_overlay}", "click", function(sym, e) {
         var overlay = sym.getSymbol("overlay");
      ...
      Symbol.bindElementAction(compId, symbolName, "${_f2}", "mouseenter", function(sym, e) {
      ...
      Symbol.bindElementAction(compId, symbolName, "${_f2}", "mouseleave", function(sym, e) {
         var currentSym = sym.getSymbol("f2");
         currentSym.playReverse();
      ...
      Symbol.bindElementAction(compId, symbolName, "${_f1}", "mouseenter", function(sym, e) {
      ...
      Symbol.bindElementAction(compId, symbolName, "${_f1}", "mouseleave", function(sym, e) {
         var currentSym = sym.getSymbol("f1");
         currentSym.playReverse();
      ...
      Symbol.bindElementAction(compId, symbolName, "${_m1}", "mouseenter", function(sym, e) {
      ...
      Symbol.bindElementAction(compId, symbolName, "${_m1}", "mouseleave", function(sym, e) {
         var currentSym = sym.getSymbol("m1");
         currentSym.playReverse();
      ...
      Symbol.bindElementAction(compId, symbolName, "${_Loop}", "click", function(sym, e) {
         sym.play(0);
